...
class TextWithPhotoNewsfeed extends StatelessWidget {
  const TextWithPhotoNewsfeed({
    Key? key,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            height: cubitPost.checkSeeMore(
                    cubitPost.newsFeedModel.newsFeed![index].content!.text!)
                ? h(290)
                : h(272),
            child: Stack(
              children: [
                ...
                BlocBuilder<NewsfeedCubit, NewsfeedState>(
                  builder: (context, state) {
                    return Positioned(
                      bottom: cubitPost.checkSeeMore(cubitPost
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          cubitPost.checkSeeMore(cubitPost.newsFeedModel
                                  .newsFeed![index].content!.text!)
                              ? InkWell(
                                  onTap: () {
